...
public class UserAuthController {
	...
	public ResponseEntity<User> registerUser(@RequestBody User user) throws UserNotFoundException{
    	try {
    		User userById = authService.findByUserIdAndPassword(user.getUserId(), user.getPassword());
    		if(userById == null) {
	...
	*/
    ...
    public String getToken(String userName, String password) throws Exception{
    	...
    	User isUserExists = authService.findByUserIdAndPassword(userName, password);
